...
\textbf{Variant} & \textbf{Ablated component} & St.~2 ($25^2$) & St.~4 ($50^2$) & \textbf{Spawns} & \textbf{Switch} & \textbf{K$\geq$2} & \textbf{$H(f)$} \\
 & & & & & (\%) & (\%) & (nats) \\
\midrule
Full THIEF & standard framework & 80.8\tiny$\pm$3.7\% & \textbf{13.7\tiny$\pm$4.8\%} & 0.5 & 4.7 & 35 & 0.67 \\
w/o incubation & $\tau_{\mathrm{iso}}=0$ (skip sandbox) & 80.3\tiny$\pm$3.5\% & 12.4\tiny$\pm$4.7\% & 0.5 & 3.9 & 25 & 0.78 \\
w/o Fisher & uniform recombination & \textbf{83.3\tiny$\pm$4.8\%} & 13.5\tiny$\pm$2.9\% & 0.3 & 2.1 & 25 & 0.66 \\
clone-best & best parent $+$ noise & 78.7\tiny$\pm$3.0\% & 12.4\tiny$\pm$4.0\% & 0.6 & 7.5 & 35 & 0.63 \\
w/o balance & $\alpha_{\mathrm{bal}}=0$ & 82.7\tiny$\pm$1.1\% & 12.6\tiny$\pm$2.3\% & 0.3 & 0.3 & 33 & 0.00 \\
w/o hysteresis & $\epsilon=0$ (no barrier) & 83.2\tiny$\pm$0.9\% & 13.2\tiny$\pm$1.4\% & 0.3 & 2.8 & 17 & 0.85 \\
fixed-cadence & periodic updates & 82.8\tiny$\pm$2.6\% & 10.3\tiny$\pm$0.9\% & 3.0 & 25.2 & 100 & 0.90 \\
\bottomrule
\end{tabular}
\end{table*}
