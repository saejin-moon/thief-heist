...
# E-COOP Specific
ECOOP_EVOLUTION_START = 75
ECOOP_EVOLUTION_INTERVAL = 75
ECOOP_GRACE_UPDATES = 20
ECOOP_RAMP_UPDATES = 15
ECOOP_CULL_WINDOW_UPDATES = 15  # Consecutive 0% usage updates before an expert goes extinct
ECOOP_MUTATION_NOISE = 0.05
ECOOP_CROSSOVER_DAMPING = 1e-4
ECOOP_MUTANT_ENVS = 2  # Number of dedicated exploration envs during burn-in grace period
