...
\item {\bf Experiments compute resources}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: Section~\ref{sec:setup} and Appendix~\ref{sec:app_compute} document the hardware (NVIDIA GeForce RTX 3080 Ti GPU, AMD Ryzen 9 5900X 12-core CPU), environment counts, per-stage training budgets, and measured throughput.
