% Auto-generated against src/py/constants.py and trainer implementations. Do not edit manually.
\begin{table}[t]
\centering
...
Updates per Stage & 100/100/250/450/800 (THIEF, 16 envs); $2\times$ more for 8-env baselines \\\
...
Plateau Trigger ($\Delta_{\text{win}}$) & $< 0.03$ over the last 100 episodes ($\ge$ 200 recorded) \\
